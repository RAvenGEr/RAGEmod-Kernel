...
/* UV */
int exp_UV_mV[6] = { 1300000, 1300000, 1200000, 1100000, 1000000, 975000 };
/**
...
static ssize_t store_UV_mV_table(struct cpufreq_policy *policy,
      ...
      unsigned int ret = -EINVAL;
      int i = 0;
      ret = sscanf(buf, "%d %d %d %d %d %d %d", &exp_UV_mV[0], &exp_UV_mV[1], &exp_UV_mV[2], &exp_UV_mV[3], &exp_UV_mV[4], &exp_UV_mV[5]);
      if(ret != 6) {
              return -EINVAL;
      }
      else
              for( i = 0; i < 6; i++ )
              {
                 ...
                 else if (exp_UV_mV[i] < CPU_UV_MV_MIN)
                 {
